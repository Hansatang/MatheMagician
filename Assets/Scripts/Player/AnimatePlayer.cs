...
namespace Player
{
    ...
    public class AnimatePlayer : MonoBehaviour
    {
        ...
        private static readonly int LastHorizontalX = Animator.StringToHash("LastMoveX");
        private static readonly int LastVerticalY = Animator.StringToHash("LastMoveY");
        ...
        private void IsMoving(bool moving, Vector2 movementVector)
        {
            ...
            if (_isMoving)
            {
                _anim.SetFloat(LastHorizontalX, movementVector.x);
                _anim.SetFloat(LastVerticalY, movementVector.y);
            }
